  ...
  return (
    <div className="container">
      ...
      <p className="tos-paragraph">
        By using this ridiculously awesome forum, you agree to the following terms and conditions. We promise it won't be as painful as stepping on a LEGO brick but if you fail to read the small print in we cannot promise that we did not add in a clause similar to season 15 episode 1 of South Park. Triane wrote this. They are not to be trusted. -signed Triane.
      </p>
      <p className="tos-paragraph">
      ...
      <p className="tos-paragraph">
        6. You agree that you are solely responsible for your interactions and activities on the forum. We're not your babysitters, although we have an honorary babysitting license from that one time we watched our neighbor's goldfish we might be in America but we cannot police the world. Forcing us to do so will have us unleash the Kraken.
      </p>
      <p className="tos-paragraph">
      ...
      <p className="tos-paragraph">
        8. Still here? Well, depending on your response to item 7, Hello new friend, let's keep it going. Otherwise, I don't forgive you (see item 4) but we shall press on.
      </p>
      <p className="tos-paragraph">
        9. This should have been number one but we're too deep to go back. Trigger Warnings are not spoilers they're warnings. Use them. If you post anything deemed triggering by the council of chatGPT you will be muted or banned depending on how extensive the transgression. (See item 4)
      </p>
      <p className="tos-paragraph">
        10. No role playing. I won't expand.
      </p>
      <p className="tos-paragraph">
        11. A-Social is a safe space guarded by rings of fire, a three-headed 10-story attack dog, and a moat (you're allowed to swim in, the water is fine but if you're trespassing you'll have to deal with) and angels that don't believe in human concepts such as good or evil. When we ask you to be inclusive and welcoming, we don't mean we will accept things that are basic crappy human behavior. To think so makes you a fool and we do not suffer fools (see item 4).
      </p>
      <p className="tos-paragraph">
